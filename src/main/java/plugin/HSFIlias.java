...
public class HSFIlias extends IliasPlugin {
    ...
    public LoginStatus login(String username, String password) {
        ...
        try {
            post = new HttpPost("https://ilias.hs-fresenius.de/login.php");
            ...
            post = new HttpPost("https://ilias.hs-fresenius.de/" + form.attr("action"));
    ...
    public String getBaseUri() {
        return "https://ilias.hs-fresenius.de";
    }
